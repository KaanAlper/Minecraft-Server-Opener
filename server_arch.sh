...
[[ ! -f "$JAVA_8" ]] && install_java "Java 8" "jdk8-openjdk"
[[ ! -f "$JAVA_17" ]] && install_java "Java 17" "jdk17-openjdk"
[[ ! -f "$JAVA_21" ]] && install_java "Java 21" "jdk21-openjdk"
